...
public class AddSocialAccount extends Activity {
	...
	private String[] permissions = { "manage_notifications", "user_groups",
			"user_status", "offline_access", "read_stream", "share_item",
			"status_update", "read_friendlists", "user_birthday" };
			...
			facebookLogoutClick = new View.OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						tracker.trackEvent("Account events", "facebook",
								"logout", 1);
				...
				public void onClick(View v) {
					...
					editor.putBoolean(Constants.CONFIG_NOTIFICATIONS,
							!mNotificationFlag);
					mNotificationFlag = !mNotificationFlag;
					if (mNotificationFlag) {
						bt_facebook_notifications
								.setText(getString(R.string.notification_service)
										+ ": " + getString(R.string.on));

						tracker.trackEvent("Tools events",
								"facebook_notifications", "off", 1);
					} else {
						bt_facebook_notifications
								.setText(getString(R.string.notification_service)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt_facebook_notifications
				.setOnClickListener(config_facebook_notification);
						...
						new DialogListener() {
							...
							public void onComplete(Bundle values) {
								...
								params.putString("fields",
										"name,picture,id,gender,birthday,relationship_status");
		...
		public void onComplete(String response, Object state) {
			try {
				...
				try {
					...
					if (birth != null) {
						tracker.setCustomVar(1, "age",
								AnalyticsUtils.classifyReturAge(birth));
					}
				} catch (Exception e) {
					// TODO: handle exception
				}
